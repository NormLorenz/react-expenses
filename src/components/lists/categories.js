  ...
  render() {
    ...
    let categories = this.state.categories.map((category) => {
      return (
        <tr key={category.key}>
          ...
          <td><button type='button' className='w3-button w3-padding-tiny w3-white w3-border w3-border-gray w3-round' onClick={this.handleOpen.bind(this, category, operations.edit)}>Edit</button>
            &nbsp;<button type='button' className='w3-button w3-padding-tiny w3-white w3-border w3-border-gray w3-round' onClick={this.handleOpen.bind(this, category, operations.delete)}>Delete</button></td>
        </tr>
      );
    });
    ...
    return (
      <div className='w3-container'>
        ...
        <button type='button' className='w3-button w3-padding-tiny w3-white w3-border w3-border-gray w3-round w3-margin-top' onClick={this.handleOpen.bind(this, null, operations.new)}>New Category</button>
